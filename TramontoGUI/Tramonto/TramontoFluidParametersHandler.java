...
public class TramontoFluidParametersHandler 
    extends MessageHandler 
{
    ...
    // Default constructor
    //
    public TramontoFluidParametersHandler() {
    }
    ...
    //
    public void handleTramontoFluidParameters(IdeaMessage msg) {
	// save the message
	...
	try {
	    theParser.validateFluidInteractionParameters();
	    // theParser.validateFluidFluidMixingRuleParameters();
	    theParser.validatePolymerInputParameters();
	}
