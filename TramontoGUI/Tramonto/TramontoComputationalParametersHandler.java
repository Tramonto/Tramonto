...
public class TramontoComputationalParametersHandler 
    extends MessageHandler 
{
    ...
    // Default constructor
    //
    public TramontoComputationalParametersHandler() {
    }
    ...
    //
    public void handleTramontoComputationalParameters(IdeaMessage msg) {
	// save the message
	...
	try {
	    theParser.validateMeshParameters();
	    theParser.validateStartupControlParameters();
	    theParser.validateOutputFormatParameters();
	    theParser.validateCoarseningSwitches();
	    theParser.validateNonLinearSolverParameters();
	    theParser.validateLinearSolverParameters();
	    theParser.validateLocaContinuationParameters();
	}
