  ...
  /****************************************************************************************************************/
     ...
     /* DEPENDENCIES */
        RCP<NumberVisualDependency<int> > VextTypeDep = rcp(
           new NumberVisualDependency<int>(Surface_List->getEntryRCP("S1: Number of Surfaces"), SurfaceInteraction_List->getEntryRCP("SI0_Vext_type")));

        RCP<NumberVisualDependency<int> > VextMaxDep = rcp(
           new NumberVisualDependency<int>( Surface_List->getEntryRCP("S1: Number of Surfaces"), SurfaceInteraction_List->getEntryRCP("SI1_VEXT_MAX")));

        RCP<NumberVisualDependency<int> > LhardDep = rcp(
           new NumberVisualDependency<int>( Surface_List->getEntryRCP("S1: Number of Surfaces"),SurfaceInteraction_List->getEntryRCP("SI3_CAREFUL_BOUNDARIES")));

        RCP<NumberVisualDependency<int> > Lsemiperm_Dep = rcp(
           new NumberVisualDependency<int>( Surface_List->getEntryRCP("S1: Number of Surfaces"), SurfaceInteraction_List->getEntryRCP("SI5_LSemiperm")));

        RCP<StringVisualDependency> Vext1D_Dep = rcp(
           new StringVisualDependency( SurfaceInteraction_List->getEntryRCP("SI0_Vext_type"), SurfaceInteraction_List->getEntryRCP("SI2_Vext_1D"), 
                tuple<std::string>( "Vext 1D", "Vext 1D_XMIN", "Vext 1D_ORIENTATION"),true));

        RCP<StringVisualDependency> VextU3D_Dep = rcp(
           new StringVisualDependency( SurfaceInteraction_List->getEntryRCP("SI0_Vext_type"), SurfaceInteraction_List->getEntryRCP("SI4_U3D_TO_BE_INTEGRATED"),
        ...
        RCP<StringVisualDependency> UwwTF_Dep = rcp(
           new StringVisualDependency( SurfaceInteraction_List->getEntryRCP("SI0_Vext_type"), SurfaceInteraction_List->getEntryRCP("SI6_UWW_TF"), 
                tuple<std::string>("Vext for atomic surfaces"),true));

        RCP<BoolVisualDependency> VextUWW_Dep = rcp(
           new BoolVisualDependency( SurfaceInteraction_List->getEntryRCP("SI6_UWW_TF"), SurfaceInteraction_List->getEntryRCP("SI7_U3D_FOR_WW_INTERACTIONS"),true));
