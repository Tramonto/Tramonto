...
//==============================================================================
dft_PolyA22_Epetra_Operator::dft_PolyA22_Epetra_Operator(const Epetra_Map & ownedMap, int numBeads) 
  : ownedMap_(ownedMap),
...
//=============================================================================
int dft_PolyA22_Epetra_Operator::insertMatrixValue(int ownedPhysicsID, int ownedNode, int rowGID, int colGID, double value) {
