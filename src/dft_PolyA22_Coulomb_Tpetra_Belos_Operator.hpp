...
#ifndef DFT_POLYA22_COULOMB_TPETRA_BELOS_OPERATOR_H
#define DFT_POLYA22_COULOMB_TPETRA_BELOS_OPERATOR_H
...
class dft_PolyA22_Coulomb_Tpetra_Belos_Operator:
  public dft_PolyA22_Coulomb_Tpetra_Operator<Scalar, LocalOrdinal, GlobalOrdinal, Node>
{

 public:
  TYPEDEF(Scalar, LocalOrdinal, GlobalOrdinal, Node);
  typedef dft_PolyA22_Coulomb_Tpetra_Operator<Scalar,LocalOrdinal,GlobalOrdinal,Node> P22CO;
  ...
  //@{ \name Destructor.
    //! Destructor
  virtual ~dft_PolyA22_Coulomb_Tpetra_Belos_Operator();
  //@}
...
protected:
  ...
  using P22CO::poissonMap_;
  using P22CO::densityMap_;
  using P22CO::densityOnCmsMatrix_;
  using P22CO::F_location_;
};
#endif /* DFT_POLYA22_COULOMB_TPETRA_BELOS_OPERATOR_H */
