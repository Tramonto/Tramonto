...
void
get_parallel_info (int *proc, int *nprocs, int *dim)
{
...
int
md_read (char *buf, int bytes, int *source, int *type, int *flag)
{
  ...
  if (err != 0)
    (void) fprintf (stderr, "MPI_Recv error = %d\n", err);
...
int
md_write (char *buf, int bytes, int dest, int type, int *flag)
{
  ...
  if (err != 0)
    (void) fprintf (stderr, "MPI_Send error = %d\n", err);
...
int
md_wrap_iread (void *buf, int bytes, int *source, int *type,
	       MPI_Request * request)
/*******************************************************************************
...
int
md_wrap_wait (void *buf, int bytes, int *source, int *type, int *flag,
	      MPI_Request * request)
/*******************************************************************************
...
int
md_wrap_iwrite (void *buf, int bytes, int dest, int type, int *flag,
		MPI_Request * request)
/*******************************************************************************
...
void
parallel_info (int *proc, int *nprocs, int *dim, MPI_Comm comm)
{
...
int
md_mpi_iread (void *buf, int bytes, int *source, int *type,
...
int
md_mpi_wait (void *buf, int bytes, int *source, int *type, int *flag,
	     MPI_Request * request, int *icomm)
/*******************************************************************************
...
int
md_mpi_iwrite (void *buf, int bytes, int dest, int type, int *flag,
	       MPI_Request * request, int *icomm)
/*******************************************************************************
