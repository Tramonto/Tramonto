...
public:
  ...
  typedef dft_HardSphereA11_Tpetra_Operator<Scalar,MatrixType> HS11TO;
  typedef dft_HardSphereA22_Tpetra_Operator<Scalar,MatrixType> HS22TO;
  typedef dft_A22Matrix_Tpetra_Operator<Scalar,MatrixType> A22MTO;
