...
/*
 *  FILE: dft_surfaces_sphericalCavity3D.c
 *
 *  This file contains the routines used to set up a spherical cavity
 *  in a 3-dimensional computational problem. 
 *
 */

#include "dft_surfaces_sphericalCavity3D.h"
/****************************************************************************/
void surface_sphericalCavity3D_inSurfaceTest(int iwall,int iwall_type,int loc_inode,int flag_setup_Xwall,
