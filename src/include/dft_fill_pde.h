...
void load_poissons_eqn (int i_box, int inode_box, int loc_i, int *ijk_box,
			...
			int fill_flag);
void load_polarize_poissons_eqn (int i_box, int inode_box, int loc_i,
...
void load_nonlinear_transport_eqn (int i_box, int inode_box, int loc_i,
				   int *ijk_box, double *mat_row,
				   double *resid, double *x, int *bindx_tmp,
				   int fill_flag, int iunk);
void load_linear_transport_eqn (int i_box, int inode_box, int loc_i,
				int *ijk_box, double *mat_row, double *resid,
				double *x, int *bindx_tmp, int fill_flag,
				int iunk);
