...
extern
int     Cont_type_1;      /* type of Field #1 continuation */
extern
int     Cont_type_2;      /* type of Field #2 continuation */
extern
...
extern
int     Print_header; /* logical to supress header printing in dft_force.dat */
extern
int     Lper_area;  /*logical for per unit are outputs of params */ 
extern
int     Nruns;           /* Number of runs to perform (varying the mesh)     */
extern
int     Nruns2;   /* Number of different values for Field #2 to try         */
extern
double  Del_1[NWALL_MAX];    /*Stepping parameter for field #1  */
extern
double  Del_2[NWALL_MAX];   /* stepping parameter for Field #2        */
extern
...
extern
double  Param_cont2[NWALL_MAX];   /* Array to save initial set points of field #2  */
extern
int     Imain_loop;    /* Couter on the number of times through the program  */
extern
int     Imain_loop_2;    /* Couter on the number of times through the program  */
...
extern
int     Surface_type[NWALL_MAX];    /* Type of surfaces of interest                     */
extern
int     Orientation[NWALL_MAX];  /* Orientation of planar/bumpy infinite walls*/
extern
double  WallParam[NWALL_MAX];/* Array[Nwall] of a characteristic wall parameter*/
extern
double  WallParam_2[NWALL_MAX];/* Array[Nwall] of a characteristic wall parameter*/
extern
double  WallParam_3[NWALL_MAX];/* Array[Nwall] of a characteristic wall parameter*/
extern
...
extern
int     Ipot_wf_n;    /* Potential Type for neutral part of w-f interactions */
extern
...
extern
int     Iguess2;        /* Type of initial guess */
extern
...
extern
double  Sigma_wf[NWALL_MAX][NCOMP_MAX];/* Array of w-f interaction diameters */
extern
double  Eps_wf[NWALL_MAX][NCOMP_MAX];  /* Array of w-f interaction energies  */
extern
double  Cut_wf[NWALL_MAX][NCOMP_MAX];  /* Array of w-f cutoff distances      */
extern
double  Sigma_ww[NWALL_MAX][NWALL_MAX];/* Array of w-w interaction diameters */
extern
double  Eps_ww[NWALL_MAX][NWALL_MAX];  /* Array of w-w interaction energies  */
extern
double  Cut_ww[NWALL_MAX][NWALL_MAX];  /* Array of w-w cutoff distances      */
...
extern
double  Sigma_w[NWALL_MAX];  /* Array[Nwall] of w-w interaction diameters    */
extern
double  Eps_w[NWALL_MAX];    /* Array[Nwall] of w-w interaction energies     */
extern
double  Rho_w[NWALL_MAX];    /* Array[Nwall] of w-w interaction energies     */
extern
double  Elec_param_w[NWALL_MAX]; /* Array: surf charge(potential) per area  */
extern
int     Type_bc_elec[NWALL_MAX];/* Array of surface b.c.'s for charged systems    */
extern 
...
extern
int     Lpoint_charge; /* Logical for point volumetric charges */
extern
