...
/*
 *  FILE: dft_surfaces_cylinder2D.c
 *
 *  This file contains the routines used to set up cylinders of infinite
 *  extent (2 dimensional computational problem).
 *
 */

#include "dft_surfaces_cylinder2D.h"
/****************************************************************************/
void surface_cylinder2D_inSurfaceTest(int iwall,int iwall_type,int loc_inode,int flag_setup_Xwall,
