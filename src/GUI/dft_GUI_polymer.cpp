                  ...
                  Teuchos::RCP<Teuchos::ParameterList> PolymerGraft_List)
{
  ...
  int idim,i,j,k,max,counter;
    ...
    RCP<FileNameValidator> CrFile_Validator = rcp(new FileNameValidator);
        ...
        /* set up parameters */
        /*********************/
   if (set_defaults_from_old_format_file && Type_poly!=NONE){
