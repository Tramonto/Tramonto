...
int 
dft_linprobmgr_setcoarsenednodeslist
(void * linprobmgr, int numgids, int * gids) 
{
  if(numgids == 0){
    return 0;
...
int 
dft_linprobmgr_finalizeblockstructure
(void * linprobmgr) 
{
  BLPM * linprobmgr_ = (BLPM *) linprobmgr;
...
int 
dft_linprobmgr_initializeproblemvalues
(void * linprobmgr) 
{
  BLPM * linprobmgr_ = (BLPM *) linprobmgr;
...
int 
dft_linprobmgr_insertrhsvalue 
(void * linprobmgr, int iunk, int inode, double value) 
{
  BLPM * linprobmgr_ = (BLPM *) linprobmgr;
...
int 
dft_linprobmgr_insertonematrixvalue 
(void * linprobmgr, int iunk, int ownednode,int junk, int boxnode, double value) 
{
  BLPM * linprobmgr_ = (BLPM *) linprobmgr;
...
int 
dft_linprobmgr_insertmultinodematrixvalues 
(void * linprobmgr, int iunk, int ownednode, int junk, int * boxnodeindices, 
 double *values, int numEntries) 
{
...
int 
dft_linprobmgr_insertmultiphysicsmatrixvalues 
(void * linprobmgr, int iunk, int ownednode, int *junkindices, int boxnode, 
 double *values, int numEntries) 
{
...
int 
dft_linprobmgr_finalizeproblemvalues
(void * linprobmgr) 
{
  BLPM * linprobmgr_ = (BLPM *) linprobmgr;
...
double 
dft_linprobmgr_getmatrixvalue 
(void * linprobmgr, int iunk, int ownednode,int junk, int boxnode) 
{
  BLPM * linprobmgr_ = (BLPM *) linprobmgr;
...
int 
dft_linprobmgr_setrhs
(void * linprobmgr, double** x) 
{
  BLPM * linprobmgr_ = (BLPM *) linprobmgr;
...
int 
dft_linprobmgr_writeMatrix
(void * linprobmgr, char * filename, char * matrixName, char * matrixDescription) 
{
  BLPM * linprobmgr_ = (BLPM *) linprobmgr;
...
int 
dft_linprobmgr_applymatrix
(void * linprobmgr, double**x, double** b) 
{
  BLPM * linprobmgr_ = (BLPM *) linprobmgr;
  int numOwnedNodes = linprobmgr_->getNumOwnedNodes();
  int numUnknownsPerNode = linprobmgr_->getNumUnknownsPerNode();
...
// Deaglan: Modidy here
int
dft_linprobmgr_importsingleunknownr2c
(void * linprobmgr, double* x, double *b)
{
